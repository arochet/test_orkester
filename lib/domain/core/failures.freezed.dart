...
/// @nodoc
abstract class _$$InvalidCoordinateCopyWith<T, $Res>
    implements $ValueFailureCopyWith<T, $Res> {
  factory _$$InvalidCoordinateCopyWith(_$InvalidCoordinate<T> value,
          $Res Function(_$InvalidCoordinate<T>) then) =
      __$$InvalidCoordinateCopyWithImpl<T, $Res>;
  @override
  @useResult
  $Res call({T failedValue});
}
...
/// @nodoc
class __$$InvalidCoordinateCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res, _$InvalidCoordinate<T>>
    implements _$$InvalidCoordinateCopyWith<T, $Res> {
  __$$InvalidCoordinateCopyWithImpl(_$InvalidCoordinate<T> _value,
      $Res Function(_$InvalidCoordinate<T>) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$InvalidCoordinate<T>(
      failedValue: freezed == failedValue
          ? _value.failedValue
          : failedValue // ignore: cast_nullable_to_non_nullable
              as T,
...
class _$InvalidCoordinate<T>
    with DiagnosticableTreeMixin
    implements InvalidCoordinate<T> {
  const _$InvalidCoordinate({required this.failedValue});
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$InvalidCoordinate<T> &&
            const DeepCollectionEquality()
                .equals(other.failedValue, failedValue));
  }
  ...
  _$$InvalidCoordinateCopyWith<T, _$InvalidCoordinate<T>> get copyWith =>
      __$$InvalidCoordinateCopyWithImpl<T, _$InvalidCoordinate<T>>(
          this, _$identity);
...
abstract class InvalidCoordinate<T> implements ValueFailure<T> {
  const factory InvalidCoordinate({required final T failedValue}) =
