...
abstract class LocationFailure with _$LocationFailure {
  ...
  const factory LocationFailure.insufficientPermission() = _InsufficientPermission;
  const factory LocationFailure.unableToUpdate() = _UnableToUpdate;
  const factory LocationFailure.invalidCoordinate(double coordinate) = _InvalidCoordinate;
}
