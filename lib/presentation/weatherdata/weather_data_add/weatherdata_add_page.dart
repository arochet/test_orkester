import 'widget/weatherdata_form.dart';
...
@RoutePage()
class WeatherDataAddPage extends StatelessWidget {
  const WeatherDataAddPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MainScaffold(
      title: 'WeatherDataAdd',
      child: ShowComponentFile(
        child: Padding(
          padding: EdgeInsets.all(10),
          child: WeatherDataFormProvider(),
        ),
      ),
    );
  }
