...
class LocationRepository implements ILocationRepository {
  ...
  List<WeatherData> get listWeatherData {
    ...
    return [
      ...
      WeatherData(
        id: UniqueId.fromUniqueString('0'),
        date: DateTime(2023, now.month, now.day, 12),
      ...
      WeatherData(
        id: UniqueId.fromUniqueString('0'),
        date: DateTime(2023, now.month, now.day, 13),
        type: TypeWeather(TypeWeatherState.rain),
        temperature: Temperature(24),
        windSpeed: 18,
      ),
      WeatherData(
        id: UniqueId.fromUniqueString('0'),
        date: DateTime(2023, now.month, now.day, 14),
        type: TypeWeather(TypeWeatherState.rain),
        temperature: Temperature(24),
        windSpeed: 18,
      ),
      WeatherData(
        id: UniqueId.fromUniqueString('0'),
        date: DateTime(2023, now.month, now.day, 15),
        type: TypeWeather(TypeWeatherState.rain),
        temperature: Temperature(24),
        windSpeed: 18,
      ),
      WeatherData(
        id: UniqueId.fromUniqueString('0'),
        date: DateTime(2023, now.month, now.day, 16),
        type: TypeWeather(TypeWeatherState.rain),
        temperature: Temperature(24),
        windSpeed: 18,
      ),
